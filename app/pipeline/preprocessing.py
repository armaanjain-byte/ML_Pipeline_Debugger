...
class Preprocessor:
    ...
    def handle_missing_values(
        ...
        """
        Backward-compatible missing-value handler.
        """
    ...
    def _get_feature_names(
        ...
        """
        Backward-compatible feature-name accessor.
        """
    ...
    def build_preprocessor(
        ...
        """
        Builds and fits preprocessing pipeline.
        """
    ...
    def preprocess(
        ...
        if self.preprocessor is None:
            raise RuntimeError(
                "Preprocessor was not initialized correctly."
            )
    ...
    def _extract_feature_names(
        ...
        for (
            ...
            transformer,
            original_columns,
        ) in self.preprocessor.transformers_:
            ...
            if (
                ...
                numeric_feature_names = (
                    self._extract_numeric_feature_names(
    ...
    def _extract_numeric_feature_names(
        ...
        if (
            ...
            if indicator is not None:
                ...
                missing_feature_indices = getattr(
                    indicator,
                    "features_",
                    [],
                )
    ...
    def _ensure_dense_array(
        self,
        transformed_matrix,
    ):
        """
        Ensures deterministic ndarray output.
        """
